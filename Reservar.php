...
<form method="Post">
    ...
    <input type="text" maxlength="30" name="nomequarto" value="<?php $nomQ=$_GET['nomQ']; print $nomQ; ?>" readonly>
 
    <input type="date" maxlength="12" name="datareser" min="2023-06-13"  max="2023-07-30" >

    <hr>
    <h4 class="text-justify col-md-8" id="DTEntrada">Data de Entrada</h4>
    
    <input type="date" maxlength="12" name="dataentrada" min="2023-06-13" max="2023-07-09">
    <h4 class="text-justify col-md-8" id="DTEntrada">Data de Saída</h4>
    <input type="date" maxlength="12" name="datasaída" min="2023-06-13" >
